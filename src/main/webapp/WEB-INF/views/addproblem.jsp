...
<h2 style="text-align:center;">Add Problem</h2>
 ...
 <form:form modelAttribute="problemDto" action="addProblem" method="post" id="editForm" style="margin-left:500px;margin-bottom:10px;">
<form:textarea rows="4" cols="50" path="content" id="text"></form:textarea>
<form:input type="text" path="pid" style="display:none;"/>
 <input type="submit" value ="Add" style="margin: 20px;width: 200px;height: 30px;">
</form:form>
</div>
</body>
</html>